...
public class Init {
    ...
    public ArrayList<Vehicule> initVehicules(){
        ...
        Vehicule newVehicule2= new Electric(1330,1000, 2000, "Tesla", 2012, 2400, 1000, TYPEVEHICULE.USED, "AAD-003", propertyCard2, soat2, mechanicalReview2, TYPEAUTOMOBILE.SEDAN, 4, "yes", TYPECHARGER.FAST, 7, 1);
